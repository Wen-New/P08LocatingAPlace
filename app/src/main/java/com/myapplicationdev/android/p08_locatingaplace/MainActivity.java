...
public class MainActivity extends AppCompatActivity {
    ...
    private LatLng poi_RP, poi_Rochor, poi_TP, poi_SG;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mapFragment.getMapAsync(new OnMapReadyCallback() {
            ...
            public void onMapReady(GoogleMap googleMap) {
                ...
                poi_SG = new LatLng(1.3440852,103.6839579);
                ...
                poi_Rochor = new LatLng(1.296972, 103.852336);
                ...
                poi_TP = new LatLng(1.3478173,103.9158625);
        ...
        btn2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (map != null) {
                    map.moveCamera(CameraUpdateFactory.newLatLngZoom(poi_Rochor,
                            15));
                }
            }
        });
        ...
        btn3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (map != null) {
                    map.moveCamera(CameraUpdateFactory.newLatLngZoom(poi_TP,
                            15));
                }
            }
        });
